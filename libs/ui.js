...
ui.prototype._drawBook_drawRow2 = function (index, enemy, top, left, width, position) {
    ...
    if (second_line.length > 0) {
        ...
        core.fillText('ui', one[1], col1 + 45, position, null, b13);
...
ui.prototype._drawStatistics = function (floorIds) {
    ...
    core.drawText([
        ...
        +"总计打死了"+statistics.battle+"个怪物，得到了"+core.formatBigNumber(statistics.money)+"反物质，"+core.formatBigNumber(statistics.exp)+"点经验。\n\n"
...
ui.prototype._drawStatistics_generateText = function (obj, type, data) {
    ...
    if (core.flags.statusBarItems.indexOf('enableMoney')>=0) text+="，总反物质数"+data.monster.money;
